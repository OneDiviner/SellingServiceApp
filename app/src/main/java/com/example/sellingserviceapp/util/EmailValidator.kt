...
fun validateEmail(email: String): String {
    return when {
        ...
        !email.matches("^[-a-zA-z0-9+=_~]+(?:\\.[-a-zA-z0-9+=_~]+)*@(?:[a-z0-9]([-a-zA-z0-9]{0,61}[a-z0-9])?\\.)*(amazon|abarth|abbott|aero|arpa|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|nameState|net|org|pro|tel|travel|[a-z][a-z])".toRegex()) -> "Неверный формат почтового адресса. Проверьте правильность ввода"
